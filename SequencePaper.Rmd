...
seqfplot(sequence_data[census_wide$sequence_cluster %in% 1:5, ], 
         group = census_wide$sequence_cluster[census_wide$sequence_cluster %in% 1:5], 
         sortv = "from.start", 
         border = NA, 
         with.legend = TRUE, 
...
# Plot only for clusters 1 to 5 using simple indexing
seqfplot(sequence_data[census_wide$sequence_cluster %in% 6:10, ], 
         group = census_wide$sequence_cluster[census_wide$sequence_cluster %in% 6:10], 
         sortv = "from.start", 
         border = NA, 
         with.legend = TRUE, 
         main = "Sequence Frequency Plot")
