...
```
  ...
  9. White and Mixed Race to White Majority
  10. White and Mixed Race to Asian Majority
  ...
  As expected, most of the pathways of change exhibit some diversification, though we do see the formation of Hispanic and Asian Majority tracts over time time frame. Only one pathway led to the formation of majority Black residents (Cluster 8) and this represents a very small share of tracts in the city (3%). The was no pathway to the overwhelming majority White neighborhood type that was common at the beginning of the study period. One trajectory showed a transition from 
